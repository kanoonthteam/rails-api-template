...
Doorkeeper.configure do
  ...
  # Provide support for password flow
  grant_flows %w[password refresh_token]
  
  # Skip authorization for password flow
  ...
  resource_owner_authenticator do
    # Since this is an API-only app, we'll authenticate via the password flow
    # This block is only needed if you're using the authorization code flow
  end
  
  # Configure resource owner password credentials flow
